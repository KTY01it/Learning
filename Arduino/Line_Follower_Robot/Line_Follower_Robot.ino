// IR Sensors
int sensor1 = 4;      // Left most sensor
int sensor2 = 3;
int sensor3 = 2;
int sensor4 = 1;      
int sensor5 = 0;      // Right most sensor
// Initial Values of Sensors
int sensor[5] = {0, 0, 0, 0, 0};

// Motor Variables
int ENA = 5;              //Motor Trái
int motorInput1 = 6;
int motorInput2 = 7;
int motorInput3 = 8;
int motorInput4 = 9;
...
//  digitalWrite(ledPin2, LOW);
  ...
  Serial.begin(112500);                     //setting serial monitor at a default baund rate of 9600
  delay(500);
...
//test
    ...
    error = -2;
  else if ((sensor[0] == 1) && (sensor[1] == 0) && (sensor[2] == 0) && (sensor[3] == 1) && (sensor[4] == 1))  // ko lệch
    error = -1;
    ...
    error = 1;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 0) && (sensor[4] == 1))  // lệch trái nhiều
    error = 2;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 0) && (sensor[4] == 0))  // lệch trái nhiều
    error = 3;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 0))  // lệch trái nhiều
    error = 4;
